...
ニュースは、重大トピック2〜3本と、番組後半の軽めの政治・行政トピック **「政界珍景」** を複数扱います。

政界珍景には、政治家・政党に加え、官僚、行政、警察など政治権力の周辺で起きた珍事ややらかしも含めます。正式な定義は `docs/terminology.md` を参照してください。
...
- 新規制作では「こぼれ話」ではなく「政界珍景」と表記する

詳細は `docs/terminology.md`、`docs/personas.md`、`docs/newsroom-script-style.md`、`prompts/script-generation.md` を参照してください。
